...
###########################					BUILDING THE DATAFRAME												##############################	
    ...
    mainpath = '/beegfs/data/TOPnanoAODv6/ttW_MC_Ntuples_skim_mvaVars/'#" los que estan con skim:"/beegfs/data/TOPnanoAODv6/ttW_MC_Ntuples_skim_mvaVars/mva_vars_v2/"  #"/beegfs/data/TOPnanoAODv6/ttW_MC_Ntuples_skim/"
    ...
    flavouring(df_ttw)
    charge(df_ttw)
    same_mask=(df_ttw['lep2_charge']==df_ttw['lep1_charge']).sum()
    diff_mask=(df_ttw['lep2_charge']!=df_ttw['lep1_charge']).sum()
    print('2lss:{0}\n 2los:{1}'.format(same_mask,diff_mask))
...
############################################################################    HERE THE PREVIOUS MUESTRAS VARS ################    
...
############################################################################    UP TO HERE THE PREVIOUS MUESTRAS VARS ################       
    ...
    vars_train_gboost= ['htJet25j_Recl', 'lep2_pt', 'lep2_charge', 'jet3_pt' ,'jet4_pt', 'lep1_charge',
     'notBjets', 'jet5_pt', 'deltarjet', 'mlj12' ,'deltarjb22', 'MET_pt' ,'jet6_pt',
     'mlj11' ,'jet1_btagDeepFlavB' ,'lep1_pt' ,'jet2_btagDeepFlavB',
     'nBJetLoose25_Recl' ,'mlj21' ,'deltaetalep', 'nBJetMedium25_Recl', 'B1_mass',
     'mll', 'nBJetMedium40_Recl', 'B1_eta', 'jet2_eta', 'lep1_eta', 'jet4_eta',
     'lep2_eta' ,'deltarlb11', 'B2_eta', 'jet2_pt', 'jet1_eta', 'mlj22',
     'jet3_btagDeepFlavB', 'jet3_eta' ,'deltarlj11' ,'deltarjb12']#, 'jet5_eta',
     #'jet6_eta', 'deltarjb11', 'jet7_pt', 'deltarlb21']# 'deltaphilep', 'jet3_mass',
     #'jet1_mass' ,'jet4_mass' ,'deltarlj22', 'jet2_mass', 'deltarlj21', 'jet7_eta',
     #'lep2_mass' ,'deltarlj12']
    
    vars_train_RF=['htJet25j_Recl' ,'jet3_pt', 'nJet25_Recl', 'notBjets', 'jet3_mass' ,'jet2_pt',
     'jet4_pt', 'jet5_pt', 'lep2_charge' ,'jet4_mass' ,'MET_pt' ,'jet1_pt', 'mlj12',
     'deltarjet', 'mlj11' ,'jet5_phi' ,'jet1_btagDeepFlavB' ,'jet1_mass',
     'jet5_mass' ,'lep1_pt', 'jet5_btagDeepFlavB', 'jet2_mass', 'jet5_eta',
     'B1_mass', 'lep1_charge' ,'jet1_eta', 'combipt', 'jet2_btagDeepFlavB', 'B1_pt',
     'mlj21', 'jet6_btagDeepFlavB','lep1_eta', 'B1_eta' ,'jet6_pt' ,'jet2_eta',
     'deltarlb11']# ,'deltarlj11', 'jet3_btagDeepFlavB' ,'deltarjb21',
     #'deltaphilj11' ,'jet4_btagDeepFlavB']# 'jet4_phi', 'jet3_eta', 'jet4_eta',
    # 'jet6_mass', 'deltaphilj12', 'deltaphilep' ,'deltarlj12' ,'deltaphilj21',
    # 'deltaphilj22' ,'jet3_phi']
    ...
    # save the model
    filename = 'saved_models/RF_ttw-ttbar.joblib'
    ...
    gboost = xgb.XGBClassifier(n_estimators=100,eval_metric='logloss',subsample=0.8,max_depth=5,learning_rate=0.5,n_jobs=-1,use_label_encoder=False)
				
    gboost.fit(X_train_gboost,y_train_gboost)  #Training of the GradBoost
    filename2 = 'saved_models/BDT_ttw-ttbar.joblib'
    ...
    #filename3 = 'saved_models/linear_model_4.pkl'
    #joblib.dump(model, open(filename3, 'wb'))
    model.save('saved_models/NN_ttW-ttbar.h5')
