...
@np.vectorize
def mass_2(l1pt,l1eta,l1phi,l1m,l2pt,l2eta,l2phi,l2m):
	l14vec=r.TLorentzVector()
	l14vec.SetPtEtaPhiM(l1pt,l1eta,l1phi,l1m)
		
	l24vec=r.TLorentzVector()
	l24vec.SetPtEtaPhiM(l2pt,l2eta,l2phi,l2m)
		
	return (l14vec+l24vec).M()
